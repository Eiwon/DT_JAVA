...
//				myFrame.setVisible(true);
				...
				myFrame.btnNewButton.addActionListener(new ActionListener() {
		...
		btn2.setFont(new Font("궁서체", Font.BOLD, 30));
		btn2.setBounds(22, 139, 377, 95);
